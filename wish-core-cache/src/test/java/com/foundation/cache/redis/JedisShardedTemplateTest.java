...
public class JedisShardedTemplateTest {
    ...
    public void beforeInit() {
        ...
        jedisTemplate = new JedisShardedTemplate(jedisPool);
    ...
    public void stringActions() {
        ...
        try {
            ...
            System.out.println("剩余时间" + jedisTemplate.ttl(key));
            System.out.println(jedisTemplate.get(key));
            System.out.println("" + jedisTemplate.exists(key));
    ...
    public void listActions() {
        ...
        jedisTemplate.lpush("strKey", strArr);
        assertThat(jedisTemplate.llen("strKey")).isEqualTo(3);
        // remove elements
        jedisTemplate.lpush(key, value);
        jedisTemplate.lpush(key, value);
        jedisTemplate.lpush(key, value);
